...
import AmazonWorkFlow from "./AmazonWorkFlow";
      ...
      <div className="">
        <div className="mt-24  mb-44 md:mb-16  h-[600px] md:h-auto">
          <div className="hero h-[600px]">
            ...
            <div className=" border-yellowBorderColor hero-content w-[90%] md:w-[60%]   p-5 rounded-md  ">
              <div className=" text-center  ">
                <h1 className=" text-white text-3xl   md:text-[30px] xl:text-[3rem] lg:leading-[70px] ">
                  {serve.title}
                </h1>
                <div className="flex my-5 ">
                  {/* <div  className=' w-1 border border-border_color bg-border_color rounded-lg mr-6' ></div> */}
                  {/* <p className=' text-sm  lg:text-lg text-pretty '>{truncateDescription(serve.description)}</p> */}
                  <p className=" text-sm  lg:text-lg text-pretty ">
                    {serve.description}
                  </p>
                </div>
