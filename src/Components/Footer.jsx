...
<footer
  ...
  <div class="mx-6 md:flex  py-10  text-left">
    ...
    <div class="">
        <h6
          class="mb-4 flex items-center  font-semibold uppercase md:justify-start">
    ...
    <div class=" w-full md:w-[60%] md:pl-5  grid gap-10 md:gap-20 grid-cols-2  md:grid-cols-3 ">
  ...
  <div class="bg-black/5 p-6 text-center border-t border-border_color">
